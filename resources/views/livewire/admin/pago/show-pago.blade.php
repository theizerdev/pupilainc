                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li><h6 class="dropdown-header">Formato A4</h6></li>
                                <li>
                                    <a class="dropdown-item" href="{{ route('admin.pagos.comprobante', ['pago' => $pago->id, 'formato' => 'a4']) }}" target="_blank">
                                        <i class="fas fa-file-pdf me-2"></i> A4 (Original + Copia)
                                    </a>
                                </li>
                                <li><hr class="dropdown-divider"></li>
                                <li><h6 class="dropdown-header">Formato Media Carta</h6></li>
                                <li>
                                    <a class="dropdown-item" href="{{ route('admin.pagos.comprobante', ['pago' => $pago->id, 'formato' => 'carta']) }}" target="_blank">
                                        <i class="fas fa-file-pdf me-2"></i> Media Carta (Original + Copia)
                                    </a>
                                </li>
                            </ul>
