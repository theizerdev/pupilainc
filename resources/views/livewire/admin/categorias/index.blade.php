    ...
    <div class="">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted">Gestión de categorías y clasificación de elementos</p>
            </div>
            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="me-2" style="width: 40px; height: 40px; background-color: {{ $categoria->color }}; border-radius: 4px;">
                                                <center><i class="menu-icon tf-icons ri {{ $categoria->icono }} mt-2 text-white"></i></center>
                                            </div>
