<div>
    <div>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-0 text-gray-800">Editar Subespecialidad Médica</h1>
                <p class="text-muted">Actualice la información de la subespecialidad</p>
            </div>
            <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('empresa_id') is-invalid @enderror" 
                                            ...
                                            @foreach($empresas as $empresa)
                                                <option value="{{ $empresa->id }}" {{ $empresa_id == $empresa->id ? 'selected' : '' }}>{{ $empresa->razon_social }}</option>
                                            @endforeach
                                        </select>
                                        @error('empresa_id')
                                            <span class="invalid-feedback">{{ $message }}</span>
