...
<div class="py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-plus-circle me-2"></i>Crear Subespecialidad Médica</h1>
                        ...
                        <form wire:submit.prevent="store">
                            ...
                            <div class="alert alert-info d-flex align-items-start" role="alert">
                                ...
                                <div>
                                    ...
                                    Esta subespecialidad se registrará automáticamente para:
                                    <ul class="mb-0 mt-2">
                        ...
                        <div class="text-center p-4" 
                            ...
                            <div class="mb-3" style="transition: transform 0.3s ease;" 
                                ...
                                <div class="badge d-inline-block px-4 py-3 shadow-lg" 
                                    ...
                                    <span class="d-block fw-bold" style="letter-spacing: 1px;">{{ $codigo ?: 'SUB001' }}</span>
                                </div>
                            </div>
...
function updateDynamicTip() {
    ...
    if (especialidadId) filledFields++;
    ...
    const tips = [
        "Complete el nombre para comenzar",
        "Seleccione la especialidad principal relacionada",
        "Seleccione un color distintivo que represente esta subespecialidad",
...
document.addEventListener('DOMContentLoaded', function() {
    const inputs = ['nombre', 'especialidad_id', 'color', 'icono', 'descripcion'];
    inputs.forEach(id => {
