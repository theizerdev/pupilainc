<div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0">
            <i class="fas fa-user-md me-2"></i>Crear Médico
        </h2>
                    ...
                    <div class="card-body">
                        ...
                        @if($especialidad_id)
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        <label>Subespecialidades (Opcional)</label>
                    ...
                    <div class="card-body">
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary btn-lg">
                                <i class="fas fa-save me-2"></i>Crear Médico
                            </button>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="small mb-0">
                            ...
                            <li>Se creará automáticamente un usuario con rol de Médico.</li>
