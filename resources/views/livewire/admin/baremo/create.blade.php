...
<div class="py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-plus-circle me-2"></i>Crear Servicio</h1>
                <p class="text-muted">Complete el formulario para registrar un nuevo servicio médico</p>
            </div>
            <div>
                        ...
                        <form wire:submit.prevent="save">
                            ...
                            <div class="alert alert-info d-flex align-items-start" role="alert">
                                ...
                                <div>
                                    ...
                                    Este servicio se registrará automáticamente para:
                                    <ul class="mb-0 mt-2">
