                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                                ...
                                <ol class="breadcrumb breadcrumb-style1 mb-2">
                                    <li class="breadcrumb-item">
                                        <a href="{{ route('admin.recepcion.dashboard') }}" class="text-white-50">
                                            <i class="ri ri-home-line me-1"></i>Recepción
                                        </a>
                                    </li>
                            ...
                            <h4 class="text-white mb-1 fw-bold">
                                <i class="ri ri-file-list-3-line me-2"></i>Pre-consulta Médica
                            </h4>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="avatar avatar-sm me-2">
                                <span class="avatar-initial rounded-circle bg-label-primary">
                                    <i class="ri ri-edit-line ri-16px"></i>
                                </span>
                            </div>
                            <div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="avatar avatar-sm me-2">
                                <span class="avatar-initial rounded-circle bg-label-secondary">
                                    <i class="ri ri-stethoscope-line ri-16px"></i>
                                </span>
                            </div>
                            <div>
                    ...
                    <div class="d-flex justify-content-center gap-2 flex-wrap mb-3">
                        @if($edadFormateada)
                            <span class="badge bg-label-primary rounded-pill">
                                <i class="ri ri-user-heart-line me-1"></i>{{ $edadFormateada }}
                            </span>
                        @endif
                        @if($paciente->genero)
                        ...
                        <span class="badge bg-label-{{ $totalCitas > 0 ? 'success' : 'warning' }} rounded-pill">
                            <i class="ri ri-history-line me-1"></i>{{ $totalCitas > 0 ? 'Recurrente' : 'Primera vez' }}
                        </span>
                    </div>
                    ...
                    <div class="d-flex align-items-center">
                        <div class="avatar avatar-sm me-2">
                            <span class="avatar-initial rounded bg-label-info">
                                <i class="ri ri-contacts-book-line ri-16px"></i>
                            </span>
                        </div>
                            ...
                            <li class="d-flex align-items-center py-2">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="small text-muted">
                                        <i class="ri ri-phone-line me-1"></i>{{ $paciente->tutor->telefono ?? 'Sin teléfono' }}
                ...
                <div class="card card-border-shadow-success">
                    <div class="card-header pb-2">
                        <div class="d-flex align-items-center">
                            <div class="avatar avatar-sm me-2">
                                <span class="avatar-initial rounded bg-label-success">
                                    <i class="ri ri-calendar-check-line ri-16px"></i>
                                </span>
                            </div>
                    ...
                    <div class="card-body pt-1">
                        <div class="d-flex align-items-center mb-2">
                            <i class="ri ri-time-line me-2 text-muted"></i>
                        ...
                        @if($cita->especialidad)
                            <div class="d-flex align-items-center mb-2">
                                <i class="ri ri-hospital-line me-2 text-muted"></i>
                                <span>{{ $cita->especialidad->nombre }}</span>
                            </div>
                        @endif
                        @if($cita->medico)
                            <div class="d-flex align-items-center">
                                <i class="ri ri-stethoscope-line me-2 text-muted"></i>
                    ...
                    <div class="card-body py-3">
                        <div class="d-flex align-items-center">
                            <div class="avatar avatar-sm me-3">
                                <span class="avatar-initial rounded bg-label-warning">
                                    <i class="ri ri-calendar-close-line ri-16px"></i>
                                </span>
                            </div>
                            <div>
                ...
                <div class="card-header border-bottom">
                    <div class="d-flex align-items-center">
                        <div class="avatar me-3">
                            <span class="avatar-initial rounded bg-label-primary">
                                <i class="ri ri-file-list-3-line ri-20px"></i>
                            </span>
                        </div>
                        <div>
                    ...
                    <form wire:submit="iniciarCuestionario">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text"><i class="ri ri-hospital-line"></i></span>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text"><i class="ri ri-stethoscope-line"></i></span>
                                ...
                                @if(empty($medicos) && $especialidad_id)
                                    <small class="text-warning mt-1 d-block">
                                        <i class="ri ri-error-warning-line me-1"></i>No hay médicos disponibles para esta especialidad
                                    </small>
                                @endif
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                @enderror
                                <div class="form-text">
                                    <i class="ri ri-information-line me-1"></i>Esta información será visible para el médico antes de iniciar la consulta.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="divider">
                            <div class="divider-text">
                                <i class="ri ri-whatsapp-line text-success me-1"></i> Envío por WhatsApp
                            </div>
                        </div>
                            ...
                            <div class="card-body py-3">
                                <div class="d-flex align-items-start">
                                    <div class="avatar me-3 flex-shrink-0">
                                        <span class="avatar-initial rounded bg-label-success">
                                            <i class="ri ri-whatsapp-line ri-20px"></i>
                                        </span>
                                    </div>
                                    <div>
                                        ...
                                        <div class="d-flex align-items-center flex-wrap gap-2">
                                            ...
                                            @if($telefonoDestino)
                                                <span class="badge bg-label-success rounded-pill">
                                                    <i class="ri ri-check-line me-1"></i>Número destino: <strong>{{ $telefonoDestino }}</strong>
                                                </span>
                                                @if(!$paciente->telefono && $paciente->tutor)
                                                    <span class="badge bg-label-info rounded-pill">
                                                        <i class="ri ri-parent-line me-1"></i>Teléfono del tutor
                                                    </span>
                                                @endif
                                            @else
                                                <span class="badge bg-label-danger rounded-pill">
                                                    <i class="ri ri-error-warning-line me-1"></i>Sin número de teléfono registrado
                                                </span>
                        ...
                        <div class="d-flex justify-content-between align-items-center pt-2">
                            ...
                            <button type="submit" class="btn btn-primary" wire:loading.attr="disabled">
                                <span wire:loading.remove wire:target="iniciarCuestionario">
                                    <i class="ri ri-send-plane-fill me-2"></i>Enviar Cuestionario
                                </span>
