    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted">Modifique la información de la especialidad #{{ $especialidad->id }}</p>
            </div>
            <div>
                        ...
                        <div class="p-3 bg-light border-top">
                            <div class="row text-center">
                                <div class="col-6 border-end">
                                    ...
                                    <strong class="h5 mb-0">#{{ $especialidad->id }}</strong>
                                </div>
                                <div class="col-6">
                                    <small class="text-muted d-block">Creada</small>
                                    <strong class="h5 mb-0">{{ $especialidad->created_at->format('d/m/Y') }}</strong>
                                </div>
                            </div>
                        </div>
                    </div>
