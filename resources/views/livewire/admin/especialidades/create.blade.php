    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted">Complete el formulario para registrar una nueva especialidad</p>
            </div>
            <div>
                        ...
                        <form wire:submit.prevent="save">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               id="nombre" 
                                               wire:model="nombre" 
                                               placeholder="Ej: Oftalmología, Cardiología, etc.">
                                        @error('nombre')
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                          ...
                                          rows="3" 
                                          placeholder="Descripción detallada de la especialidad y sus servicios..."></textarea>
                                @error('descripcion')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="card-body text-center">
                        <div class="mb-3">
                            <span class="badge" style="background-color: {{ $color }}; color: white; font-size: 1.2em;">
                                <i class="fas {{ $icono }}"></i> {{ $codigo ?: 'ESP001' }}
                            </span>
                        </div>
                        <h5>{{ $nombre ?: 'Nombre de Especialidad' }}</h5>
                        <p class="text-muted">{{ $descripcion ?: 'Descripción de la especialidad' }}</p>
