<div>
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-plus-circle me-2"></i>Crear Especialidad Médica</h1>
                <p class="text-muted">Complete el formulario para registrar una nueva especialidad médica</p>
            </div>
            <div>
                        ...
                        <form wire:submit.prevent="save">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               placeholder="Ej: Oftalmología, Cardiología..."
                                               autocomplete="off">
                                        @error('nombre')
                            ...
                            <div class="alert alert-info d-flex align-items-start" role="alert">
                                ...
                                <div>
                                    ...
                                    Esta especialidad se registrará automáticamente para:
                                    <ul class="mb-0 mt-2">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @enderror
                                        <small class="form-text text-muted">Color distintivo para esta especialidad</small>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                          ...
                                          rows="4" 
                                          placeholder="Describa los servicios y características principales de esta especialidad..."></textarea>
                                @error('descripcion')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="text-center p-4" 
                            ...
                            <div class="mb-3" style="transition: transform 0.3s ease;" 
                                ...
                                <div class="badge d-inline-block px-4 py-3 shadow-lg" 
                                    ...
                                    <span class="d-block fw-bold" style="letter-spacing: 1px;">{{ $codigo ?: 'ESP001' }}</span>
                                </div>
                            </div>
                            ...
                            <div class="rounded p-2" style="background-color: #f8f9fa;">
                                ...
                                <div class="border rounded p-2 mb-2" style="background: white;">
                                    <div class="d-flex align-items-center" 
                                        ...
                                        <small class="fw-bold">{{ $nombre ?: 'Especialidad' }}</small>
                                    </div>
                                </div>
                                ...
                                <div class="border rounded p-2" style="background: white;">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <small>{{ $nombre ?: 'Especialidad' }}</small>
                                        </div>
...
function updateDynamicTip() {
    ...
    const tips = [
        "Complete el nombre para comenzar",
        "Seleccione un color distintivo que represente esta especialidad",
