                        ...
                        <div class="channel-row">
                            ...
                            <div>
                                @if($selectedConnection)
                                    <span class="connection-badge {{ $selectedConnection['status'] }}">
                                        <i class="ri ri-check-circle-fill"></i>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $modules[$editingModule]['label'] ?? $editingModule }} - {{ ucfirst($editingAction) }}" disabled>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Destinatario</label>
                                <input type="text" class="form-control" value="{{ $recipientTypes[$editingRecipient] ?? $editingRecipient }}" disabled>
                            </div>
                            <div class="mb-3">
