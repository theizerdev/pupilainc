<div>
    ...
    <div class="mb-4">
        ...
        <h2 class="fw-semibold"><i class="ri ri-edit-line me-2"></i>Editar Mascota</h2>
        <p class="text-muted">Modifique la información del paciente veterinario</p>
    </div>
        ...
        <div class="form-section">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <small class="text-muted">Dejar vacío para mantener la foto actual. Formatos: JPG, PNG. Máx: 2MB</small>
                </div>
            </div>
        </div>
